  ...
  <article>
    <Player :ref="player.ref('main')" :state="player_states['main']"
      ...
      <Section heading="Overview">
        ...
        <Figure :image="makeThemedImage('/images/projects/proto_engine/architecture_{theme}.png')"
                alt="UML-like class relationship diagram." />
        <Figure :image="makeThemedImage('/images/projects/proto_engine/scene_{theme}.png')"
      ...
      <Section heading="Important API Differences">
        ...
        <Figure :image="makeThemedImage('/images/projects/proto_engine/coordinate_system_{theme}.png')"
        ...
        <Figure :image="makeThemedImage('/images/projects/proto_engine/uv_coordinate_system_{theme}.png')"
        ...
        <Figure :image="makeThemedImage('/images/projects/proto_engine/winding_order_{theme}.png')"
