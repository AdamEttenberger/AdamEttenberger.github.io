...
/** @type {string} */
const CACHE_VERSION = '1752157638|18366659889';
/** @type {string} */
const CACHE_PREFIX = 'Tile Match-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'tile_match.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["tile_match.html","tile_match.js","tile_match.offline.html","tile_match.icon.png","tile_match.apple-touch-icon.png","tile_match.audio.worklet.js","tile_match.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["tile_match.wasm","tile_match.pck"];
